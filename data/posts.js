export const posts = [
  ...
  body: [
    ...
    "E-Marker kontrolü yapmanın birden fazla yolu var. En garanti yöntem, kabloyu profesyonel USB-C test cihazlarına (USB-C tester, PD analyzer) bağlayıp gerçek zamanlı PD müzakeresini okumak. İkinci yöntem, güvenilir markaların sertifikalı kablolarını tercih etmek ve mümkünse üreticinin teknik dökümanını incelemek. Üçüncü yöntem ise pratik saha testi: aynı adaptör ve aynı cihazla farklı kabloları deneyerek şarj gücünü, sıcaklığı ve kararlılığı karşılaştırmak.",
  ...
  },
  {
    ...
    description:
      "Taşınabilir USB-C lehim kalemi test ettik. Güç tüketimi, performans ve pratiklik analizi.",
