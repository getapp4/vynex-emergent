export const posts = [
  {
    ...
    description: "4K 120Hz ve 8K desteği için doğru HDMI 2.1 kablosunu nasıl seçersiniz? Bandwidth, sertifikasyon ve kalite ipuçları.",
  ...
  },
  {
    ...
    description: "Kullanmadığınız akıllı telefonu ücretsiz uygulamalarla IP kamera yapın. Adım adım kurulum rehberi.",
  ...
  },
  {
    ...
    description: "Taşınabilir USB-C lehim kalemi test ettik. Güç tüketimi, performans ve pratiklik analizi.",
  ...
  },
  {
    ...
    description: "Sertifikalı HDMI kabloları nasıl ayırt edersiniz? Logo standartları ve sahte ürünlerden korunma yolları.",
  ...
  },
  {
    ...
    description: "PoE, PoE+ ve PoE++ arasındaki farklar. IEEE 802.3 standartları ve doğru ekipman seçimi.",
    slug: "poe-siniflari",
  ...
  },
  {
    ...
    description: "Thunderbolt 4 ve USB4 protokollerinin farkları, hız limitleri ve uyumluluk rehberi.",
  ...
  },
  {
    ...
    description: "DisplayPort 2.1'in UHBR10, UHBR13.5 ve UHBR20 modları. 16K görüntü desteği ve bandwidth hesaplamaları.",
